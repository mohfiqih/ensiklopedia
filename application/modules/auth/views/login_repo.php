...
<head>
    ...
    <title>Login | Repository PHB</title>
    ...
    <meta property="og:title" content="Login | Ensiklopedia Pintar Seri Buah" />
        ...
        <div class="wrap-login100">
            ...
            <form action="auth/proses" method="POST" class="login100-form validate-form">
                ...
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    ...
                    <!-- <button style="float: right;height: 35px;margin-right: 10px;" type="button"
                              class="btn btn-success"><span class="btn-label"><i class="fa fa-times"></i></span>
                              Tambah File</button> -->
                </div>
                <?php } ?>
                ...
                <div class="wrap-input100 validate-input" data-validate="Password is required">
                    <input class="input100" for="inputPassword" id="password" type="password" name="password"
                        autocomplete="off" id="inputPassword" autocomplete="off" placeholder="Password" required />
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                ...
                <div class="text-center p-t-12">
                    ...
                    <a class="txt2" href="" style="text-decoration: none;"> Username / Password Hubungi Admin
                    </a>
                </div>

                <div class="text-center p-t-136">
                    <a class="txt2" href="" style="text-decoration: none;"> Copyright &copy; 2022 - Repository
                        v1.0.0
                    </a>
                </div>
            </form>
