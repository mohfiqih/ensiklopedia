            ...
            <div class="slider__container">
                ...
                <div class="slider__item slide-burger">
                    <div class="slider__content grid">
                        <div class="column">
                            ...
                            <h1 class="title"
                                style="color: white;font-size: 25px;margin-right: 50px;margin-bottom: 100px;">
                                Aku adalah jeruk<br />Berbentuk bulat<br />Aku berwarna hijau atau
                                oranye<br />Aku
                ...
                <div class="slider__item slide-burger">
                    <div class="slider__content grid">
                        ...
                        <div class="column"><img width="350" height="350" style="margin-bottom: 100px;" ;
                                src="<?php echo base_url('assets'); ?>/buku/images/anggur.png" class="image burger">
                        </div>
                    </div>
                </div>
                <div class="slider__item slide-astronaut">
                    <div class="slider__content grid">
                        ...
                        <div class="column"><img width="350" height="350" style="margin-bottom: 100px;" ;
                                src="<?php echo base_url('assets'); ?>/buku/images/apel.png" class="image astronaut">
                        </div>
                    </div>
                </div>
                <div class="slider__item slide-coffee">
                    <div class="slider__content grid">
                        <div class="column">
                            <h1 class="title"
                                style="font-size: 80px;color: black;margin-right: 50px;margin-bottom: 10px;">
                                Belimbing<br />(Star Fruit)</h1>
                            <h1 class="title"
                                style="color: white;font-size: 25px;margin-right: 50px;margin-bottom: 100px;">
                                Aku berbentuk mirip dengan bintang<br />Kulitku berwarna hijau atau
                                kuning<br />Aku
                        ...
                        <div class="column"><img width="350" height="350" style="margin-bottom: 100px;" ;
                                src="<?php echo base_url('assets'); ?>/buku/images/belimbing.png" class="image cup">
                        </div>
                    </div>
                </div>
                <div class="slider__item slide-burger">
                ...
                <div class="slider__item slide-astronaut">
                    <div class="slider__content grid">
                        <div class="column">
                            ...
                            <h1 class="title"
                                style="color: white;font-size: 25px;margin-right: 50px;margin-bottom: 100px;">
                                Aku adalah durian<br />Berbentuk bulat<br />Kulitku menyerupai duri<br />Aku
                                kaya akan
                                akan serat
                            </h1>
                            <!-- <h1 class="title"
                ...
                <div class="slider__item slide-coffee">
                    <div class="slider__content grid">
                        ...
                        <div class="column"><img width="350" height="350" style="margin-bottom: 100px;" ;
                                src="<?php echo base_url('assets'); ?>/buku/images/mangga.png" class="image cup">
                        </div>
                    </div>
                </div>
                <div class="slider__item slide-burger">
                    <div class="slider__content grid">
                        <div class="column">
                            ...
                            <h1 class="title"
                                style="color: white;font-size: 25px;margin-right: 50px;margin-bottom: 100px;">
                                Aku berbentuk lonjong<br />Kulitku berwarna hijau atau kuning<br />Aku
                                mengandung
                                vitamin c
                            </h1>
                            <!-- <h1 class="title"
                        ...
                        <div class="column"><img width="350" height="350" style="margin-bottom: 100px;" ;
                                src="<?php echo base_url('assets'); ?>/buku/images/pepaya.png" class="image burger">
                        </div>
                    </div>
                </div>
                <div class="slider__item slide-astronaut">
                    <div class="slider__content grid">
                        ...
                        <div class="column"><img width="350" height="350" style="margin-bottom: 100px;" ;
                                src="<?php echo base_url('assets'); ?>/buku/images/manggis.png" class="image astronaut">
                        </div>
                    </div>
                </div>
                <div class="slider__item slide-coffee">
                    <div class="slider__content grid">
                        <div class="column">
                            ...
                            <h1 class="title"
                                style="color: white;font-size: 25px;margin-right: 50px;margin-bottom: 100px;">
                                Aku berbentuk lonjong<br />Kulitku berwarna coklat dan tajam<br />Aku mengandung
                                vitamin
                                A
                            </h1>
                            <!-- <h1 class="title"
                        ...
                        <div class="column"><img width="350" height="350" style="margin-bottom: 100px;" ;
                                src="<?php echo base_url('assets'); ?>/buku/images/salak.png" class="image cup">
                        </div>
                    </div>
                </div>
                <div class="slider__item slide-burger">
                ...
                <div class="slider__item slide-coffee">
                    <div class="slider__content grid">
                        ...
                        <div class="column"><img width="350" height="350" style="margin-bottom: 100px;" ;
                                src="<?php echo base_url('assets'); ?>/buku/images/nanas.png" class="image cup">
                        </div>
                    </div>
                </div>
                <?php
