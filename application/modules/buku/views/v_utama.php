                         ...
                         <div class="col-lg-8">
                              <div class="header-hero-content text-center">
                                   ...
                                   <p class="text wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.8s">
                                        Aplikasi Baca Untuk Anak Usia Baca
                                   </p>
     ...
     <section class="services-area pt-120">
          <div class="container">
                    ...
                    <div class="col-lg-10">
                         <div class="section-title text-center pb-40">
                              <h3 class="title" id="features">
                                   Menu Ensiklopedia Pintar<br />
                                   <span>Aplikasi baca untuk anak usia baca</span>
                              </h3>
              ...
              ">
                              ...
                              <div class="services-content mt-30">
                                   <h4 class="services-title"><a href="#">Dongeng</a></h4>
                                   <p class="text">
                                        Lorem ipsum dolor sit amet,consetetur sadipscing elitr,
                                        seddiam nonu eirmod tempor invidunt labore.
                                   </p><br />
               ...
               <div class="row">
                    <div class="col-lg-6">
                         <div class="video-content mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                              <img class="dots" src="<?php echo base_url('assets/menu/images/dots.svg'); ?>"
                                   alt="epin" />
                              <div class="video-wrapper">
                                   ...
                                   <div class="video-icon">
                                        <a href="<?php echo base_url('https://youtu.be/sMW_fy8Lttg'); ?>"
                                             class="video-popup"><i class="lni-play"></i></a>
                                   </div>
                              </div>
                              <!-- video wrapper -->
                         </div>
